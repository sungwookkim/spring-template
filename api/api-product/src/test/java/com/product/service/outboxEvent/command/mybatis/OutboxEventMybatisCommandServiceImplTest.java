...
@SpringBootTest
public class OutboxEventMybatisCommandServiceImplTest {
    @Autowired
    ...
    void updateStatus1() {
        ...
        this.outboxEventMybatisCommandServiceImpl.updateStatus(byStatusOrderByCreatedAtAsc, OutboxEventStatus.PUBLISHED);
    }
}
